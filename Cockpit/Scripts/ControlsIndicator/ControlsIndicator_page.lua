...
base.material       = MakeMaterial(nil,{11, 255, 1, 100})
...
pitch_scale.material	   = MakeMaterial("arcade.tga",{11, 255, 1, 255})
...
roll_scale.material	      = MakeMaterial("arcade.tga",{11, 255, 1, 255})
...
stick_position.material	       = MakeMaterial("arcade.tga",{11, 255, 1, 255})
stick_position.tex_params	   = {330/512,365.5 / 512,2*tex_scale,2*tex_scale/0.8}
stick_position.element_params  = {"ROLL_INPUT", "PITCH_INPUT"} 
...
rudder_index.vertices    = {{-2.0*line_width , -line_width},
                            ...
                            { 2.0*line_width ,  line_width},
                            { 2.0*line_width , -line_width}}
rudder_index.element_params  = {"YAW_INPUT"}  
...
rudder_index.material	       = MakeMaterial("arcade.tga",{11, 255, 1, 255})
...
collective_index.vertices    = {{-2.7*line_width , -line_width},
                                {-2.7*line_width ,  line_width},
                                { -0.2*line_width ,  line_width},
                                { -0.2*line_width , -line_width}}
collective_index.element_params  = {"THROTTLE_LEFT"}  
...
collective_index.material=MakeMaterial("arcade.tga",{11, 255, 1, 255})
...
collective_index             = Copy(roll_scale)
collective_index.vertices    = {{ 0.5*line_width , -line_width},
                                { 0.5*line_width ,  line_width},
                                { 3.0*line_width ,  line_width},
                                { 3.0*line_width , -line_width}}
collective_index.element_params  = {"THROTTLE_RIGHT"}  
collective_index.controllers = {{"move_up_down_using_parameter",0, size}}
collective_index.tex_params	   = {256/512,176.5/512,0.5*tex_scale/3,2*tex_scale/3}
collective_index.init_rot    = {-90,0,0}
collective_index.material=MakeMaterial("arcade.tga",{11, 255, 1, 255})
