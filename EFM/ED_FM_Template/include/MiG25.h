...
//give parameter sof surface under your aircraft
	ED_FM_TEMPLATE_API void ed_fm_set_surface(double h, //height of surface under the center of aircraft
											  double h_obj, //height of surfacw ith objects
	...
	*/
	...
	ED_FM_TEMPLATE_API bool ed_fm_make_balance(double& ax,
											   double& ay,
											   double& az,
											   double& vx,
											   double& vy,
	...
	ED_FM_TEMPLATE_API void ed_fm_unlimited_fuel(bool vlaue);
